...
По сути, описание игры соотносится с игрой, как текст со смыслом текста.
\begin{displaymath}
\xymatrix{
...
На множестве схем введем отношение эквивалентности. Назовем схемы $(\mathcal{G}, T_{\omega}, \alpha) $ и  $(\mathcal{G}, T_{\omega}, \beta) $ эквивалентными ( $(\mathcal{G}, T_{\omega}, \alpha) \simeq (\mathcal{G}, T_{\omega}, \beta) $), если существует биекция $$f:   T_{\omega} \rightarrow T_{\omega}, $$
 такая, что 
$$ \alpha \circ f = \beta. $$
...
$$(\mathcal{G}, T_{\omega}, \alpha) \simeq (\mathcal{G}, T_{\omega}, \beta) \iff ((\mathcal{G}, T_{\omega}, \alpha)\succcurlyeq (\mathcal{G}, T_{\omega}, \beta))\cup ((\mathcal{G}, T_{\omega}, \alpha)\preccurlyeq (\mathcal{G}, T_{\omega}, \beta))   $$ 
 ...
 Будем говорить, что схема $(\mathcal{G}, T_{\omega}, \alpha)$ {\it уточняет} схему $(\mathcal{G}, T_{\omega}, \beta)$, 
а  схема $(\mathcal{G}, T_{\omega}, \beta )$ {\it обобщает} схему $(\mathcal{G}, T_{\omega},\alpha)$, если
 имеет место:
$$(\mathcal{G}, T_{\omega}, \alpha)\succcurlyeq (\mathcal{G}, T_{\omega}, \beta). $$
...
\section{Модель реакции на события}

Выбираем степень детализации схемы и анализируем прообраз схемы описания игры.
% $$\begin{xy}
%   \newdir{ >}{{}*!/-2ex/\dir{>}}
% \xymatrix{
