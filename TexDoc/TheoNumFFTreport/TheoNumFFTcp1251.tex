...
\title{Вычисление свертки при помощи теоретико-числовых преобразований.}
...
Реализована целочисленная операция двумерной свертки для размеров $2^m\times 2^n$, где $0 \leqslant m,n  \leqslant 10 $ .
