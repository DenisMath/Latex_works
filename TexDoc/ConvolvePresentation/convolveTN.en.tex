...
\title[Convolution with theoretical-number methods] % (optional, use only with long paper titles)
{Convolution with theoretical-number methods}

\subtitle
{Two dimensional convolutions of  lengths $2^n$}
...
\date[December, 2011] % (optional, should be abbreviation of conference name)
{Presentation , 2011}
...
\begin{frame}{Main Characteristics Of The Studied Algorithms}
  % - A title should summarize the slide in an understandable fashion
  %   for anyone how does not follow everything on the slide itself.

 We study the convolution algorithms are well adapted for the processing of complex images
  \begin{itemize}
  \pause
  \item
       pay special attention to ease of implementation and speed performance of these algorithms
  \pause
  \item
      impose the condition of no computational errors in these algorithms
  \end{itemize}


\end{frame}

\begin{frame}{Applications Of Two-Dimentional Number-Theoretical Convolutions}
  % - A title should summarize the slide in an understandable fashion
  %   for anyone how does not follow everything on the slide itself.

 
Integer FFT applied in various areas related to image processing and finding a correlation, such as 
tomography  and processing of images taken by satellite. The motivation to use number-theoretical FFT is
 \begin{itemize}
 \pause
  \item
